...
var ActionClient = require('../core/Action');
 ...
 */
class TF2Client extends EventEmitter {
    /**
    ...
    constructor(options) {
        ...
        this.actionClient = new ActionClient({
            ...
            actionType: 'tf2_web_republisher/TFSubscription',
            // omitStatus : true,
            // omitResult : true
        });
    ...
    updateGoal() {
        ...
        console.log('call service update goal')
